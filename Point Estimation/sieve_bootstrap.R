...
sieve_bootstrap <- function(fun_dat, grid, p_m_order, ncomp_porder_selection, CPV_percent = 0.85, VAR_type = "none", B, burn_in)
{
    #########
    # Step 1
    #########
    ...
    if(missing(p_m_order))
    {
        ...
        else 
        {
            ...
            ncomp_porder = c(which.min(VAR_AICC[is.finite(VAR_AICC)]), ncomp)
